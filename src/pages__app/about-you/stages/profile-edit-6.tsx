...
const ProfileEditSixStage = () => {
    ...
    const { typePay, setTypePay } = useAnketsBabysitter();
    ...
    return (
        ...
        <div className={styles['profile-edit-stage__top']}>
            ...
            <span className={styles['profile-edit-stage__top-description']}>шаг 6/12</span>
        </div>

        <h2 className={styles['profile-edit-stage__title']}>Какую зарплату вы хотите получать?</h2>
